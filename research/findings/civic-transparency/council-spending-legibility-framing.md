...
- Public does not automatically mean legible: DIA's 2025 council-performance page says people want to know where rates are going, says councils have been planning and reporting differently, and warns that even its standardised council-profile data cannot guarantee identical council definitions or accounting practices. [DIA, Council performance measurement](https://www.dia.govt.nz/local-government-performance-metrics)
- Existing official data gives useful baselines but does not settle the transaction-level question: Stats NZ's current annual local-authority financial-statistics CSV package covers the year ended June 2025, while DIA's July 2025 profiles cover demographics, rates revenue, debt, and operating and capital expenditure. [Stats NZ CSV catalogue result, local authority financial statistics year ended June 2025](https://www.stats.govt.nz/assets/Uploads/Local-authority-financial-statistics/Local-authority-financial-statistics-Year-ended-June-2025/Download-data/local-authority-financial-statistics-year-ended-june-2025.zip); [DIA, Council performance measurement](https://www.dia.govt.nz/local-government-performance-metrics)
- This discover pass fans the stream out into five research questions: supply-side spending-data availability, demand from residents and journalists, the new DIA official baseline, prior civic-tech efforts, and cross-council comparability. [Issue #13](https://github.com/thecolab-ai/the-for-good-project/issues/13); [Issue #15](https://github.com/thecolab-ai/the-for-good-project/issues/15); [Issue #16](https://github.com/thecolab-ai/the-for-good-project/issues/16); [Issue #17](https://github.com/thecolab-ai/the-for-good-project/issues/17); [Issue #50](https://github.com/thecolab-ai/the-for-good-project/issues/50)
...
DIA states the legibility problem directly in its council-performance measurement page: it says people want to know where their rates are going and how their council compares with others, but that assessing council performance can be difficult because each council plans and reports differently. [DIA, Council performance measurement](https://www.dia.govt.nz/local-government-performance-metrics)

DIA's first council-performance release is useful but not a substitute for the stream's research question: DIA says the council profiles and comparison tables span demographics, rates revenue, debt, and operating and capital expenditure, and says all underpinning data is available as a spreadsheet and CSV. [DIA, Council performance measurement](https://www.dia.govt.nz/local-government-performance-metrics)

DIA also flags an important comparability limit: it says officials tried to source data consistently and accommodate different council categorisations, but cannot guarantee that all councils apply the same definitions or accounting practices when reporting metrics such as staffing levels or capital expenditure by activity group. [DIA, Council performance measurement](https://www.dia.govt.nz/local-government-performance-metrics)
...
DIA's council-performance measurement work provides another official baseline: DIA says the first release focuses on financial performance, later releases will cover broader asset-management, service-delivery, and governance metrics, and the current page provides profiles and CSV/XLSX data underpinning the results. [DIA, Council performance measurement](https://www.dia.govt.nz/local-government-performance-metrics)
...
The stream should also account for existing non-government comparison efforts such as the Taxpayers' Union Ratepayers' Report, which describes itself as an annual local-government league table, and Figure.NZ, which publishes charts from local-authority statistics. [Taxpayers' Union, Ratepayers' Report 2026](https://www.taxpayers.org.nz/rpr_2026); [Figure.NZ, operating expenditure of local authorities](https://figure.nz/chart/okcV4PqsEUxjxWQy-nHozrMb2KSVsSfqn)

International prior art is relevant but should be treated as context, not a direct transplant: the UK Local Government Transparency Code says local authorities must publish expenditure over GBP500, including supplier and transaction information, while New Zealand's current official baselines identified in this pass are aggregate council-finance and profile datasets. [UK Department for Levelling Up, Housing and Communities, Local Government Transparency Code 2015](https://www.gov.uk/government/publications/local-government-transparency-code-2015); [Stats NZ, Local authority financial statistics: Year ended June 2025](https://www.stats.govt.nz/information-releases/local-authority-financial-statistics-year-ended-june-2025/); [DIA, Council performance measurement](https://www.dia.govt.nz/local-government-performance-metrics)
...
The issue thread already opened four research children from the first discover comment: #13 on supply-side council spending data, #15 on what residents and journalists ask, #16 on the 2025 DIA metrics and gaps, and #17 on prior NZ and international civic-tech efforts. [Issue #3 comment](https://github.com/thecolab-ai/the-for-good-project/issues/3#issuecomment-4860810722); [Issue #13](https://github.com/thecolab-ai/the-for-good-project/issues/13); [Issue #15](https://github.com/thecolab-ai/the-for-good-project/issues/15); [Issue #16](https://github.com/thecolab-ai/the-for-good-project/issues/16); [Issue #17](https://github.com/thecolab-ai/the-for-good-project/issues/17)
...
|---|---|---|---|
| Council spending legibility is a national-scale issue, not a niche single-council issue. | [LGNZ says there are 78 councils and describes council service roles](https://www.lgnz.co.nz/local-government-in-nz/councils-in-aotearoa/) | [Stats NZ population indicator shows a provisional national resident population of 5,361,300 at 31 March 2026](https://www.stats.govt.nz/indicators/population-of-nz/) | High |
| The issue is mainly about legibility and comparability, not whether any public reporting exists. | [Local Government Act 2002 annual-report requirements](https://www.legislation.govt.nz/act/public/2002/84/en/latest/) | [DIA says each council plans and reports differently and warns definitions/accounting practices may differ](https://www.dia.govt.nz/local-government-performance-metrics) | High |
| Existing official machine-readable baselines do not by themselves settle whether citizens can answer project-, supplier-, or transaction-level spending questions. | [Stats NZ annual local-authority financial-statistics release](https://www.stats.govt.nz/information-releases/local-authority-financial-statistics-year-ended-june-2025/) | [DIA council profiles span demographics, rates revenue, debt, and operating/capital expenditure, with comparability caveats](https://www.dia.govt.nz/local-government-performance-metrics) | Medium |
| A transaction-level disclosure model exists internationally, but this discovery pass did not find an equivalent NZ local-government norm. | [UK Local Government Transparency Code 2015](https://www.gov.uk/government/publications/local-government-transparency-code-2015) | [NZ baselines found in this pass are Stats NZ aggregate financial statistics and DIA council profiles](https://www.dia.govt.nz/local-government-performance-metrics) | Low |

## What would change this conclusion

- A completed all-council census showing that most New Zealand councils already publish machine-readable project-, supplier-, or transaction-level spending under clear open-data terms would weaken the claim that the central barrier is legibility.
...
- I could not verify, in this discover pass, how many of the 78 councils publish open spending datasets beyond statutory reports, which spending questions are most common in LGOIMA/media evidence, or whether existing council accounting structures allow robust cross-council comparisons below high-level categories.
- Human steward judgement is needed at G1 before ideation because even a technically feasible transparency tool could mislead if it compares councils without accounting for service scope, geography, growth, asset age, disaster recovery, rating base, and outsourcing differences that DIA warns affect results.
...
- [#16](https://github.com/thecolab-ai/the-for-good-project/issues/16): What do DIA's 2025 council-performance metrics cover, in what format and cadence, and which citizen questions remain unanswered?
...
6. Department of Internal Affairs. "Council performance measurement." Data release updated October 2025; water-services section updated December 2025. Accessed 2 July 2026. https://www.dia.govt.nz/local-government-performance-metrics
...
12. New Zealand Taxpayers' Union. "Ratepayers' Report 2026." Accessed 2 July 2026. https://www.taxpayers.org.nz/rpr_2026
13. Figure.NZ. "Operating expenditure of all Local Authorities, New Zealand." Accessed 2 July 2026. https://figure.nz/chart/okcV4PqsEUxjxWQy-nHozrMb2KSVsSfqn
14. Department for Levelling Up, Housing and Communities. "Local Government Transparency Code 2015." Accessed 2 July 2026. https://www.gov.uk/government/publications/local-government-transparency-code-2015
15. The For Good Project. "Streams, human gates, and where people actually fit." Accessed 2 July 2026. https://github.com/thecolab-ai/the-for-good-project/blob/main/docs/STREAMS.md
16. GitHub. "Issue #3: [Discover] Council spending is public but not legible to citizens." Accessed 2 July 2026. https://github.com/thecolab-ai/the-for-good-project/issues/3
17. GitHub. "Issue #13: [Research] Which NZ councils publish spending data beyond statutory PDFs, and in what formats?" Accessed 2 July 2026. https://github.com/thecolab-ai/the-for-good-project/issues/13
18. GitHub. "Issue #15: [Research] What do residents and local journalists actually ask about council spending?" Accessed 2 July 2026. https://github.com/thecolab-ai/the-for-good-project/issues/15
19. GitHub. "Issue #16: [Research] What do the 2025 DIA council performance metrics cover, and what gaps remain?" Accessed 2 July 2026. https://github.com/thecolab-ai/the-for-good-project/issues/16
20. GitHub. "Issue #17: [Research] What NZ and international civic-tech efforts on council spending legibility exist or have been tried?" Accessed 2 July 2026. https://github.com/thecolab-ai/the-for-good-project/issues/17
21. GitHub. "Issue #50: research: Can NZ council spending be compared across councils from existing reporting standards?" Created 2 July 2026. https://github.com/thecolab-ai/the-for-good-project/issues/50
